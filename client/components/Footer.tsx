        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12 lg:gap-16 w-full lg:w-[690px]">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-[65px] lg:mr-[-66px]">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                <Link to="/help" className="text-radut-pink font-alexandria text-sm font-normal hover:text-white transition-colors">
                  Help Centre
                </Link>
                <Link to="/faq" className="text-radut-pink font-alexandria text-sm font-normal hover:text-white transition-colors">
                  FAQ
                </Link>
                <Link to="/forum" className="text-radut-pink font-alexandria text-sm font-normal hover:text-white transition-colors">
                  Forum
                </Link>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                <a href="#" className="text-radut-pink font-alexandria text-sm font-normal hover:text-white transition-colors">
                  Facebook
                </a>
                <a href="#" className="text-radut-pink font-alexandria text-sm font-normal hover:text-white transition-colors">
                  Instagram
        ...
        <div className="flex flex-col justify-center items-start gap-5 w-full lg:w-[385px]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
            <div className="flex justify-between items-center w-full">
              ...
              >
                <svg className="w-[18px] h-[18px] text-black" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path 
