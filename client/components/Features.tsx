      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="radut-card flex flex-col items-center gap-9 p-8 md:p-12 rounded-xl">
            <div className="flex justify-center items-center w-12 h-12">
              <svg className="w-12 h-12" viewBox="0 0 48 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M40.5 30.8704V41.3704H30M39.5437 40.4113L28.5 29.3704M7.5 18.8704V8.37036H18M8.45625 9.32942L19.5 20.3704M30 8.37036H40.5V18.8704M39.5409 9.32661L28.5 20.3704M18 41.3704H7.5V30.8704M8.45906 40.4141L19.5 29.3704" stroke="#FF0088" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
          ...
          <div className="radut-card flex flex-col items-center gap-9 p-8 md:p-12 rounded-xl">
            <div className="flex justify-center items-center w-12 h-12">
              <svg className="w-12 h-12" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_3007_2)">
                  <mask id="mask0_3007_2" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="0" y="0" width="49" height="49">
                    <path d="M0.333008 0.870361H48.333V48.8704H0.333008V0.870361Z" fill="white"/>
                  </mask>
                  <g mask="url(#mask0_3007_2)">
                    <path d="M8.69287 10.1388C9.48572 9.23136 10.3505 8.38935 11.2787 7.62095" stroke="#FF0088" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M3.74365 19.8208C3.96197 17.4242 4.90644 15.1356 6.20571 13.0476" stroke="#FF0088" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M11.1391 42.0037C6.2699 37.9062 3.17334 31.7517 3.17334 24.8704C3.17334 24.609 3.17784 24.3487 3.18665 24.0895" stroke="#FF0088" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M36.1733 44.4143C32.9825 46.1938 28.977 47.2073 25.4021 47.2073C21.1744 47.2073 17.5138 46.2008 14.3306 44.4324" stroke="#FF0088" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M44.2505 13.0241C46.3923 16.4578 47.6305 20.5187 47.6305 24.8702C47.6305 31.7415 44.543 37.8882 39.686 41.9856" stroke="#FF0088" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                    <circle cx="25.4013" cy="10.5257" r="2.14835" stroke="#FF0088" strokeWidth="1.5"/>
                    <circle cx="17.0829" cy="19.9637" r="2.14835" stroke="#FF0088" strokeWidth="1.5"/>
                    <circle cx="36.5243" cy="25.4469" r="2.14835" stroke="#FF0088" strokeWidth="1.5"/>
                  </g>
                </g>
                <defs>
                  <clipPath id="clip0_3007_2">
                    <rect width="48" height="48" fill="white" transform="translate(0.333008 0.870361)"/>
                  </clipPath>
                </defs>
              </svg>
            </div>
